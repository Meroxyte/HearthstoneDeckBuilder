...
public class HearthstoneDeckBuilderApplication extends Application{
	...
	public HearthstoneDeckBuilderApplication()
	{
		...
		this.cardsList.add(new Card("Backstab", "Deal 2 damage to an undamaged minion.", 0, 0, 2,CardQuality.COMMON ,HeroesClasses.ROGUE));
		this.cardsList.add(new Card("SI:7 Agent", "Combo: Deal 2 damage.", 3, 3, 3,CardQuality.RARE ,HeroesClasses.ROGUE));
	}
